...
> Complemento da [Aula de Java para Iniciantes](../Aula%201/Aula de Java para Iniciantes.md). Aqui o programa aprende a **tomar decisões** — e a gente aprende junto, com bastante exemplo, uma pitada de história da programação e frases de gente que fez a computação acontecer.
