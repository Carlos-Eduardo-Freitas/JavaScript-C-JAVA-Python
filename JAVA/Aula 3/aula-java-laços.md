...
> Complemento das aulas anteriores: [Aula de Java para Iniciantes](../Aula%201/aula-java-basico.md) e [Estruturas Condicionais](../Aula%201/aula-java-condicionais.md). Agora vamos ensinar o programa a **repetir tarefas** sem que a gente precise copiar e colar a mesma linha de código cem vezes.
